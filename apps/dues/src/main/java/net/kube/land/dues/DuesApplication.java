...
public class DuesApplication {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(DuesApplication.class);
    ...
    public static void main(String[] args) {
        ...
        SpringApplication.run(DuesApplication.class, args);

        LOGGER.info("Started Dues Microservice...");
    }
