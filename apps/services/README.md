...
- Services is a Microservice under Enterprise Webservices Platform (Kube Land)
- It is Spring Boot Application uses Gradle and Rest API Doc
- It packages as Executable JAR


## Kube Land Services Resources


| **Useful URLs**	|
| ------------- |
| [DockerHub](https://hub.docker.com/repository/docker/navikco/services/ "Official DockerHub Artifactory for Kube Land Services")      	|
| [GitHub](https://github.com/navikco/kube/tree/master/apps/services "Official Git Repo for Kube Land Services")      	|
| [Postman JSON](https://github.com/navikco/kube/tree/master/apps/services/browse/json_tests "Postman JSON for Kube Land Services")      	|
| [Kube Land Admin Console](http://localhost:8761/admin/wallboard "Kube Land Admin Console")      	|
| [Rest API Doc](http://localhost:8761/kube/services/info/index.html "Kube Land Services Rest API Doc - Local Environment")      	|
| [CircleCI](https://circleci.com/gh/navikco/kube "Kube Land - CI/CD")      	|


## Kube Land Services CI/CD
...
## Available Profiles to run Kube Land Services Apps


| Kube Land Services Profile        | Embedded/Externalized           | Description           |
| ------------- |:-------------:|:-------------:|
...
```shell
	...
	cd services/
	./gradlew clean build
	java -jar -Dspring.profiles.active=local build/libs/services-1.0.0-SNAPSHOT.jar
...
* **Import** services/json_tests/Services.postman_collection.json into your POSTMAN
* **Fire up** the Postman Requests for Kube Land Services Endpoints 
