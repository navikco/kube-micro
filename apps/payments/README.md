...
- Payments is a Microservice under Enterprise Webservices Platform (Kube Land)
- It is Spring Boot Application uses Gradle and Rest API Doc
- It packages as Executable JAR


## Kube Land Payments Resources


| **Useful URLs**	|
| ------------- |
| [DockerHub](https://hub.docker.com/repository/docker/navikco/payments/ "Official DockerHub Artifactory for Kube Land Payments")      	|
| [GitHub](https://github.com/navikco/kube/tree/master/apps/payments "Official Git Repo for Kube Land Payments")      	|
| [Postman JSON](https://github.com/navikco/kube/tree/master/apps/payments/browse/json_tests "Postman JSON for Kube Land Payments")      	|
| [Kube Land Admin Console](http://localhost:8761/admin/wallboard "Kube Land Admin Console")      	|
| [Rest API Doc](http://localhost:8761/kube/payments/info/index.html "Kube Land Payments Rest API Doc - Local Environment")      	|
| [CircleCI](https://circleci.com/gh/navikco/kube "Kube Land - CI/CD")      	|


## Kube Land Payments CI/CD
...
## Available Profiles to run Kube Land Payments Apps


| Kube Land Payments Profile        | Embedded/Externalized           | Description           |
| ------------- |:-------------:|:-------------:|
...
```shell
	...
	cd payments/
	./gradlew clean build
	java -jar -Dspring.profiles.active=local build/libs/payments-1.0.0-SNAPSHOT.jar
...
* **Import** payments/json_tests/Payments.postman_collection.json into your POSTMAN
* **Fire up** the Postman Requests for Kube Land Payments Endpoints 
