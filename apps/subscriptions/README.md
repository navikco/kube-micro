...
- Subscriptions is a Microservice under Enterprise Webservices Platform (Kube Land)
- It is Spring Boot Application uses Gradle and Rest API Doc
- It packages as Executable JAR


## Kube Land Subscriptions Resources


| **Useful URLs**	|
| ------------- |
| [DockerHub](https://hub.docker.com/repository/docker/navikco/subscriptions/ "Official DockerHub Artifactory for Kube Land Subscriptions")      	|
| [GitHub](https://github.com/navikco/kube/tree/master/apps/subscriptions "Official Git Repo for Kube Land Subscriptions")      	|
| [Postman JSON](https://github.com/navikco/kube/tree/master/apps/subscriptions/browse/json_tests "Postman JSON for Kube Land Subscriptions")      	|
| [Kube Land Admin Console](http://localhost:8761/admin/wallboard "Kube Land Admin Console")      	|
| [Rest API Doc](http://localhost:8761/kube/subscriptions/info/index.html "Kube Land Subscriptions Rest API Doc - Local Environment")      	|
| [CircleCI](https://circleci.com/gh/navikco/kube "Kube Land - CI/CD")      	|


## Kube Land Subscriptions CI/CD
...
## Available Profiles to run Kube Land Subscriptions Apps


| Kube Land Subscriptions Profile        | Embedded/Externalized           | Description           |
| ------------- |:-------------:|:-------------:|
...
```shell
	...
	cd subscriptions/
	./gradlew clean build
	java -jar -Dspring.profiles.active=local build/libs/subscriptions-1.0.0-SNAPSHOT.jar
...
* **Import** subscriptions/json_tests/Subscriptions.postman_collection.json into your POSTMAN
* **Fire up** the Postman Requests for Kube Land Subscriptions Endpoints 
