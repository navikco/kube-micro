package net.kube.land.subscriptions;
...
public class SubscriptionsApplication {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(SubscriptionsApplication.class);
    ...
    public static void main(String[] args) {
        ...
        LOGGER.info("Started Subscriptions Microservice...");
    }
