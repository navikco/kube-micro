package net.kube.land.referrals;
...
public class ReferralsApplication {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(ReferralsApplication.class);
    ...
    public static void main(String[] args) {
        ...
        SpringApplication.run(ReferralsApplication.class, args);

        LOGGER.info("Started Referrals Microservice...");
    }
