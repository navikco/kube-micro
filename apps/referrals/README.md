...
- Referrals is a Microservice under Enterprise Webservices Platform (Kube Land)
- It is Spring Boot Application uses Gradle and Rest API Doc
- It packages as Executable JAR


## Kube Land Referrals Resources


| **Useful URLs**	|
| ------------- |
| [DockerHub](https://hub.docker.com/repository/docker/navikco/referrals/ "Official DockerHub Artifactory for Kube Land Referrals")      	|
| [GitHub](https://github.com/navikco/kube/tree/master/apps/referrals "Official Git Repo for Kube Land Referrals")      	|
| [Postman JSON](https://github.com/navikco/kube/tree/master/apps/referrals/browse/json_tests "Postman JSON for Kube Land Referrals")      	|
| [Kube Land Admin Console](http://localhost:8761/admin/wallboard "Kube Land Admin Console")      	|
| [Rest API Doc](http://localhost:8761/kube/referrals/info/index.html "Kube Land Referrals Rest API Doc - Local Environment")      	|
| [CircleCI](https://circleci.com/gh/navikco/kube "Kube Land - CI/CD")      	|


## Kube Land Referrals CI/CD
...
## Available Profiles to run Kube Land Referrals Apps


| Kube Land Referrals Profile        | Embedded/Externalized           | Description           |
| ------------- |:-------------:|:-------------:|
...
```shell
	...
	cd referrals/
	./gradlew clean build
	java -jar -Dspring.profiles.active=local build/libs/referrals-1.0.0-SNAPSHOT.jar
...
* **Import** referrals/json_tests/Referrals.postman_collection.json into your POSTMAN
* **Fire up** the Postman Requests for Kube Land Referrals Endpoints 
