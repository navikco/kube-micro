...
- Roles is a Microservice under Enterprise Webservices Platform (Kube Land)
- It is Spring Boot Application uses Gradle and Rest API Doc
- It packages as Executable JAR


## Kube Land Roles Resources


| **Useful URLs**	|
| ------------- |
| [DockerHub](https://hub.docker.com/repository/docker/navikco/roles/ "Official DockerHub Artifactory for Kube Land Roles")      	|
| [GitHub](https://github.com/navikco/kube/tree/master/apps/roles "Official Git Repo for Kube Land Roles")      	|
| [Postman JSON](https://github.com/navikco/kube/tree/master/apps/roles/browse/json_tests "Postman JSON for Kube Land Roles")      	|
| [Kube Land Admin Console](http://localhost:8761/admin/wallboard "Kube Land Admin Console")      	|
| [Rest API Doc](http://localhost:8761/kube/roles/info/index.html "Kube Land Roles Rest API Doc - Local Environment")      	|
| [CircleCI](https://circleci.com/gh/navikco/kube "Kube Land - CI/CD")      	|


## Kube Land Roles CI/CD
...
## Available Profiles to run Kube Land Roles Apps


| Kube Land Roles Profile        | Embedded/Externalized           | Description           |
| ------------- |:-------------:|:-------------:|
...
```shell
	...
	cd roles/
	./gradlew clean build
	java -jar -Dspring.profiles.active=local build/libs/roles-1.0.0-SNAPSHOT.jar
...
* **Import** roles/json_tests/Roles.postman_collection.json into your POSTMAN
* **Fire up** the Postman Requests for Kube Land Roles Endpoints 
