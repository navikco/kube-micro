package net.kube.land.invoices;
...
public class InvoicesApplication {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(InvoicesApplication.class);
    ...
    public static void main(String[] args) {
        ...
        LOGGER.info("Started Invoices Microservice...");
    }
