...
public class MarketsApplication {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(MarketsApplication.class);
    ...
    public static void main(String[] args) {
        ...
        LOGGER.info("Started Markets Microservice...");
    }
