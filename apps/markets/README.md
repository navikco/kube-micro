...
- Markets is a Microservice under Enterprise Webservices Platform (Kube Land)
- It is Spring Boot Application uses Gradle and Rest API Doc
- It packages as Executable JAR


## Kube Land Markets Resources


| **Useful URLs**	|
| ------------- |
| [DockerHub](https://hub.docker.com/repository/docker/navikco/markets/ "Official DockerHub Artifactory for Kube Land Markets")      	|
| [GitHub](https://github.com/navikco/kube/tree/master/apps/markets "Official Git Repo for Kube Land Markets")      	|
| [Postman JSON](https://github.com/navikco/kube/tree/master/apps/markets/browse/json_tests "Postman JSON for Kube Land Markets")      	|
| [Kube Land Admin Console](http://localhost:8761/admin/wallboard "Kube Land Admin Console")      	|
| [Rest API Doc](http://localhost:8761/kube/markets/info/index.html "Kube Land Markets Rest API Doc - Local Environment")      	|
| [CircleCI](https://circleci.com/gh/navikco/kube "Kube Land - CI/CD")      	|


## Kube Land Markets CI/CD
...
## Available Profiles to run Kube Land Markets Apps


| Kube Land Markets Profile        | Embedded/Externalized           | Description           |
| ------------- |:-------------:|:-------------:|
...
```shell
	...
	cd markets/
	./gradlew clean build
	java -jar -Dspring.profiles.active=local build/libs/markets-1.0.0-SNAPSHOT.jar
...
* **Import** markets/json_tests/Markets.postman_collection.json into your POSTMAN
* **Fire up** the Postman Requests for Kube Land Markets Endpoints 
