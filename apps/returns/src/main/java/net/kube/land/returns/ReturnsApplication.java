...
public class ReturnsApplication {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(ReturnsApplication.class);
    ...
    public static void main(String[] args) {
        ...
        LOGGER.info("Started Returns Microservice...");
    }
