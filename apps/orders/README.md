...
- Orders is a Microservice under Enterprise Webservices Platform (Kube Land)
- It is Spring Boot Application uses Gradle and Rest API Doc
- It packages as Executable JAR


## Kube Land Orders Resources


| **Useful URLs**	|
| ------------- |
| [DockerHub](https://hub.docker.com/repository/docker/navikco/orders/ "Official DockerHub Artifactory for Kube Land Orders")      	|
| [GitHub](https://github.com/navikco/kube/tree/master/apps/orders "Official Git Repo for Kube Land Orders")      	|
| [Postman JSON](https://github.com/navikco/kube/tree/master/apps/orders/browse/json_tests "Postman JSON for Kube Land Orders")      	|
| [Kube Land Admin Console](http://localhost:8761/admin/wallboard "Kube Land Admin Console")      	|
| [Rest API Doc](http://localhost:8761/kube/orders/info/index.html "Kube Land Orders Rest API Doc - Local Environment")      	|
| [CircleCI](https://circleci.com/gh/navikco/kube "Kube Land - CI/CD")      	|


## Kube Land Orders CI/CD
...
## Available Profiles to run Kube Land Orders Apps


| Kube Land Orders Profile        | Embedded/Externalized           | Description           |
| ------------- |:-------------:|:-------------:|
...
```shell
	...
	cd orders/
	./gradlew clean build
	java -jar -Dspring.profiles.active=local build/libs/orders-1.0.0-SNAPSHOT.jar
...
* **Import** orders/json_tests/Orders.postman_collection.json into your POSTMAN
* **Fire up** the Postman Requests for Kube Land Orders Endpoints 
