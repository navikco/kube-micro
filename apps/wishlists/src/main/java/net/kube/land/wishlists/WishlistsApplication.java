package net.kube.land.wishlists;
...
public class WishlistsApplication {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(WishlistsApplication.class);
    ...
    public static void main(String[] args) {
        ...
        LOGGER.info("Started Wishlists Microservice...");
    }
