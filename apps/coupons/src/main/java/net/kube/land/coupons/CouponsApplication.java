...
public class CouponsApplication {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(CouponsApplication.class);
    ...
    public static void main(String[] args) {
        ...
        LOGGER.info("Started Coupons Microservice...");
    }
