...
- Coupons is a Microservice under Enterprise Webservices Platform (Kube Land)
- It is Spring Boot Application uses Gradle and Rest API Doc
- It packages as Executable JAR


## Kube Land Coupons Resources


| **Useful URLs**	|
| ------------- |
| [DockerHub](https://hub.docker.com/repository/docker/navikco/coupons/ "Official DockerHub Artifactory for Kube Land Coupons")      	|
| [GitHub](https://github.com/navikco/kube/tree/master/apps/coupons "Official Git Repo for Kube Land Coupons")      	|
| [Postman JSON](https://github.com/navikco/kube/tree/master/apps/coupons/browse/json_tests "Postman JSON for Kube Land Coupons")      	|
| [Kube Land Admin Console](http://localhost:8761/admin/wallboard "Kube Land Admin Console")      	|
| [Rest API Doc](http://localhost:8761/kube/coupons/info/index.html "Kube Land Coupons Rest API Doc - Local Environment")      	|
| [CircleCI](https://circleci.com/gh/navikco/kube "Kube Land - CI/CD")      	|


## Kube Land Coupons CI/CD
...
## Available Profiles to run Kube Land Coupons Apps


| Kube Land Coupons Profile        | Embedded/Externalized           | Description           |
| ------------- |:-------------:|:-------------:|
...
```shell
	...
	cd coupons/
	./gradlew clean build
	java -jar -Dspring.profiles.active=local build/libs/coupons-1.0.0-SNAPSHOT.jar
...
* **Import** coupons/json_tests/Coupons.postman_collection.json into your POSTMAN
* **Fire up** the Postman Requests for Kube Land Coupons Endpoints 
