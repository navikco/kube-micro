...
public class LostsApplication {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(LostsApplication.class);
    ...
    public static void main(String[] args) {
        ...
        SpringApplication.run(LostsApplication.class, args);

        LOGGER.info("Started Losts Microservice...");
    }
