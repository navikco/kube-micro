...
public class VendorsApplication {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(VendorsApplication.class);
    ...
    public static void main(String[] args) {
        ...
        LOGGER.info("Started Vendors Microservice...");
    }
