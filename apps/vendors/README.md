...
- Vendors is a Microservice under Enterprise Webservices Platform (Kube Land)
- It is Spring Boot Application uses Gradle and Rest API Doc
- It packages as Executable JAR


## Kube Land Vendors Resources


| **Useful URLs**	|
| ------------- |
| [DockerHub](https://hub.docker.com/repository/docker/navikco/vendors/ "Official DockerHub Artifactory for Kube Land Vendors")      	|
| [GitHub](https://github.com/navikco/kube/tree/master/apps/vendors "Official Git Repo for Kube Land Vendors")      	|
| [Postman JSON](https://github.com/navikco/kube/tree/master/apps/vendors/browse/json_tests "Postman JSON for Kube Land Vendors")      	|
| [Kube Land Admin Console](http://localhost:8761/admin/wallboard "Kube Land Admin Console")      	|
| [Rest API Doc](http://localhost:8761/kube/vendors/info/index.html "Kube Land Vendors Rest API Doc - Local Environment")      	|
| [CircleCI](https://circleci.com/gh/navikco/kube "Kube Land - CI/CD")      	|


## Kube Land Vendors CI/CD
...
## Available Profiles to run Kube Land Vendors Apps


| Kube Land Vendors Profile        | Embedded/Externalized           | Description           |
| ------------- |:-------------:|:-------------:|
...
```shell
	...
	cd vendors/
	./gradlew clean build
	java -jar -Dspring.profiles.active=local build/libs/vendors-1.0.0-SNAPSHOT.jar
...
* **Import** vendors/json_tests/Vendors.postman_collection.json into your POSTMAN
* **Fire up** the Postman Requests for Kube Land Vendors Endpoints 
